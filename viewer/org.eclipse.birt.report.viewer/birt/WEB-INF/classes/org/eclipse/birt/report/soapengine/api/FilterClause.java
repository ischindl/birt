...
public class FilterClause implements java.io.Serializable {
	...
	public FilterClause(org.eclipse.birt.report.soapengine.api.ColumnDefinition column,
			org.eclipse.birt.report.soapengine.api.BoundDataColumn columnName, java.lang.String filterOp,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				&& ((this.column == null && other.getColumn() == null)
						|| (this.column != null && this.column.equals(other.getColumn())))
				...
				&& ((this.filterOp == null && other.getFilterOp() == null)
						|| (this.filterOp != null && this.filterOp.equals(other.getFilterOp())))
				&& ((this.operand == null && other.getOperand() == null)
						|| (this.operand != null && java.util.Arrays.equals(this.operand, other.getOperand())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getOperand() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getOperand()); i++) {
