...
public class TableLayout implements java.io.Serializable {
	...
	public TableLayout(long id, int s_Count, int g_Count, org.eclipse.birt.report.soapengine.api.TableRowInfo CH_Row,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.id == other.getId() && this.s_Count == other.getS_Count()
				&& this.g_Count == other.getG_Count()
				&& ((this.CH_Row == null && other.getCH_Row() == null)
						|| (this.CH_Row != null && this.CH_Row.equals(other.getCH_Row())))
				&& ((this.TC_Row == null && other.getTC_Row() == null)
						|| (this.TC_Row != null && this.TC_Row.equals(other.getTC_Row())))
				&& ((this.sections == null && other.getSections() == null)
						|| (this.sections != null && this.sections.equals(other.getSections())))
				&& ((this.groups == null && other.getGroups() == null)
						|| (this.groups != null && this.groups.equals(other.getGroups())));
		__equalsCalc = null;
		return _equals;
	}
